		...
		if (worker instanceof ETLReader) {
			if (startTime == -1) {
				...
				if (batchHistoryPos == batchSizeHistory.length) {
					 ...
					 * sb.append(bestSize); sb.append(", time: "); sb.append(this.batchSizeHistory[bestTime]);
					 * sb.append("\n\tBest ever batchsize:"); sb.append(bestTimeEverBatchSize); sb.append(", time: ");
					 * sb.append(bestTimeEver); sb.append("\n\tBatchsize range:" + this.batchSizeHist[1] + " to " +
					 * this.batchSizeHist[4]);
					 * 
