...
public class RawPerstIndexedMapTest extends IndexedMapTest {

    public static void main(String[] args) throws Exception {
        RawPerstIndexedMapTest ps = new RawPerstIndexedMapTest("Perst");
        ps.setUp();
        ps.testPutLarge();
    }

    public RawPerstIndexedMapTest(String name) {
        super(name);
